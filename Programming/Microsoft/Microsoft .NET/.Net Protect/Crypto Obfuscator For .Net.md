...
- [.Net 下的签名与混淆 - 周国选 - 博客园](https://www.cnblogs.com/zgx/archive/2009/06/09/1499295.html)
...
// Reduce MetaData / 减少元数据
// Remove Constant Field Values /删除常量字段值
// Mark Classes As Final(Sealed) When Possible / 如果可能，将类标记为最终（密封）
