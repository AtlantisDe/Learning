...
- [C#保存文件为无 BOM 的 utf8 格式 rztyfx 的专栏-CSDN 博客](https://blog.csdn.net/rztyfx/article/details/94165786)
...
- [C#读取文件而不占用文件的方法. - 跟着阿笨一起玩.NET - 博客园](https://www.cnblogs.com/51net/p/13874436.html)
...
```c#
var file = new System.IO.StreamWriter(path2, true, new UTF8Encoding(false));

System.IO.File.WriteAllText("", str,  System.Text.Encoding.UTF8);
...
using (var file = new System.IO.StreamWriter($@"C:\Tmp\9.txt", true, Encoding.UTF8))
{
    file.WriteLine(text0); file.Close();
}
...
```c#
string BaiduspiderPushTxt  = System.IO.File.ReadAllText($"{System.AppDomain.CurrentDomain.BaseDirectory}App/Logs/logBaiduspider.txt", System.Text.Encoding.UTF8);

System.IO.File.ReadAllText(ofd.FileName);
System.IO.File.ReadAllText(ofd.FileName,Encoding.UTF8);
...
using (var stream = new FileStream(filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite | FileShare.Delete))
using (var fileReader = new StreamReader(stream, Encoding.UTF32))
{
    // do something.
}
...
- [C#使用 StreamWriter 生成 UTF-8 无 BOM 编码格式 人生若南柯一梦-CSDN 博客 c#itextsharp utf8](https://blog.csdn.net/chinaplan/article/details/11945133)

```c#
// UTF-8无BOM编码格式
UTF8Encoding utf8 = new UTF8Encoding(false);
var file = new System.IO.StreamWriter(path2, true, utf8);

var file = new System.IO.StreamWriter(new FileStream(dlg.FileName, FileMode.Open), Encoding.UTF8);

var file = new System.IO.StreamWriter(path2, true, Encoding.UTF8);
...
- [File.ReadLines Method (System.IO)](https://docs.microsoft.com/en-us/dotnet/api/system.io.file.readlines?redirectedfrom=MSDN&view=netcore-3.1#System_IO_File_ReadLines_System_String_)
