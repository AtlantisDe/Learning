...
## 0. .NET 库，用于访问长度超过 260 个字符的文件和目录

- [UweKeim/ZetaLongPaths](https://github.com/UweKeim/ZetaLongPaths)
...
// 临时目录
// C:\Users\HelloWorld\AppData\Local\Temp\hlog.obj.log
...
// 快捷示例
string fileName = fullFileName.Substring(0,fullFileName.LastIndexOf(".")-0)
var fileName=$"{fif.FullName.Substring(0, fif.FullName.LastIndexOf(".") - 0)}.aledb",
