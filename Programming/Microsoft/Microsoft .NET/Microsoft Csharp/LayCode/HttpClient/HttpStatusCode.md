...
- [HttpStatusCode Enum (Windows.Web.Http) - Windows UWP applications](https://docs.microsoft.com/en-us/uwp/api/windows.web.http.httpstatuscode?view=winrt-19041)
- [StatusCodes Class (Microsoft.AspNetCore.Http)](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.http.statuscodes?view=aspnetcore-3.1)
- [Error Happened](https://en.wikipedia.org/wiki/List_of_HTTP_status_codes)
...
## 1. Http Status Code List

- [Status Code 状态码详解对照表 - barton123 - 博客园](https://www.cnblogs.com/QaStudy/p/11514985.html)

```c#
Status Code状态码详解对照表 状态码
...
## 2. Http Status Code List

- [多次调用仍然为 200，只是起了最简单的 express 服务器 - OSCHINA](https://www.oschina.net/question/4592376_2317753)

```c#
// 浏览器请求和ajax请求有什么区别呢？为什么在浏览器访问一个接口，第二次会自动304缓存，而ajax多次调用仍然为200，只是起了最简单的express服务器
