...
## 8. Creating and executing a task 创建和执行任务
...
[ActionDescription("纯文本,公共权限")]
public async Task<string> IsStringPublic()
{
    return await Task<string>.Run(() => { return "我是纯文本读取,公开权限."; });
}
```
